...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        copyrightLabel2->setText(QStringLiteral("Copyright &copy; 2013 The Thalercoin Consortium"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Thalercoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Thalercoin</b> version", 0));
