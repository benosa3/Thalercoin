...
public:
    ...
    void retranslateUi(QDialog *Intro)
    {
        ...
        label_2->setText(QApplication::translate("Intro", "Welcome to Thalercoin-Qt.", 0));
        label_4->setText(QApplication::translate("Intro", "As this is the first time the program is launched, you can choose where Thalercoin-Qt will store its data.", 0));
        sizeWarningLabel->setText(QApplication::translate("Intro", "Thalercoin-Qt will download and store a copy of the Thalercoin block chain. At least %1GB of data will be stored in this directory, and it will grow over time. The wallet will also be stored in this directory.", 0));
